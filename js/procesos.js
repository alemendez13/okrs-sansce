// js/procesos.js
// --- INICIO DE LA MODIFICACIÓN (Fase 6 - Lógica de Modal) ---
        ...
        .then(data => {
            ...
            data.forEach(objetivo => {
                ...
                objetivo.ResultadosClave.forEach(kr => {
                    // 3. FILTRO (CONSERVADO)
                    // Esta página solo muestra KPIs 'táctico'
                    ...
                    // --- INICIO DE LA MODIFICACIÓN (Fase 2 - Promedio KR) ---
                    ...
                    `;
                    // --- FIN DE LA MODIFICACIÓN (Fase 2 - Promedio KR) ---
...
// --- FIN DE LA MODIFICACIÓN (Fase 6 - Lógica de Modal) ---